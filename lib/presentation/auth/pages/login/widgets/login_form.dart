...
import 'package:mobile_sim_shop/presentation/auth/pages/password_configuration/forget_password.dart';
...
class LoginForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Form(
        child: Padding(
      padding: EdgeInsets.symmetric(vertical: AppSizes.spaceBtwSections.w),
      child: Column(
        children: [
          //Email
          TextFormField(
          ...
          Row(
            ...
            children: [
              ...
              TextButton(
                  onPressed: () =>
                      AppNavigator.push(context, const ForgetPassword()),
